...
void testfunction_PI_trigger_check(void)
{
    ...
    if(usage_data[0].maximum_execution_time > usage_data[0].average_execution_time &&
        ...
        usage_data[1].maximum_execution_time < 53470000 && usage_data[1].maximum_execution_time > 53460000 &&
        usage_data[1].average_execution_time < 53470000 && usage_data[1].average_execution_time > 53460000 &&
        usage_data[1].minimum_execution_time < 53470000 && usage_data[1].minimum_execution_time > 53460000)
    {
        test_result = true;
    }
}
