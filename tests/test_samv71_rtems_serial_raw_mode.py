...
def test_samv71_rtems_serial_raw_mode():
    remote_gdb_server = os.getenv("SAMV71_REMOTE_GDBSERVER", default="127.0.0.1")
    build = common.do_build("samv71-rtems-serial-raw-mode", ["deploymentview", "debug"])
    ...
    try:
        ...
        gdbmi.write("file samv71-rtems-serial-raw-mode/work/binaries/partition_1")
        ...
        errors = common.do_execute(
            "samv71-rtems-serial-raw-mode", expected, test_exe="work/binaries/partition_2"
        )
    finally:
        gdbmi.exit()
    assert not errors, "\n".join(errors)
...
if __name__ == "__main__":
    test_samv71_rtems_serial_raw_mode()
