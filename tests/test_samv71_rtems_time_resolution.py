...
def test_samv71_rtems_time_resolution():
    ...
    build = common.do_build("samv71-rtems-time-resolution/TEST-SAMV71-TIME-RESOLUTION", ["samv71", "debug"])
    stderr = build.stderr.decode("utf-8")
    assert build.returncode == 0, f"Compilation errors: \n{stderr}"

    common.run_verification_project(remote_gdb_server, 'samv71-rtems-time-resolution/TEST-SAMV71-TIME-RESOLUTION/work/binaries/partition_1', 'testfunction.c', '39')
