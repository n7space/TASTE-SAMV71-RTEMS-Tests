...
def test_samv71_rtems_cpu_usage():
    common.do_clean_build("samv71-rtems-cpu-usage/TEST-SAMV71-CPU-USAGE")
    remote_gdb_server = os.getenv("SAMV71_REMOTE_GDBSERVER", default="127.0.0.1")
    
    build = common.do_build("samv71-rtems-cpu-usage/TEST-SAMV71-CPU-USAGE", ["samv71", "debug"])
